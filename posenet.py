...
def create_posenet(weights_path=None, tune=False):
    ...
    with tf.device('/cpu:0'):
        ...
        cls1_reduction_pose = Conv2D(128,(1,1),padding='same',activation='relu',name='cls1_reduction_pose')(cls1_pool)
        ...
        cls2_reduction_pose = Conv2D(128,(1,1),padding='same',activation='relu',name='cls2_reduction_pose')(cls2_pool)
        ...
        posenet = Model(outputs=[cls1_fc_pose_xyz, cls1_fc_pose_wpqr, cls2_fc_pose_xyz, cls2_fc_pose_wpqr, cls3_fc_pose_xyz, cls3_fc_pose_wpqr], inputs=input)
